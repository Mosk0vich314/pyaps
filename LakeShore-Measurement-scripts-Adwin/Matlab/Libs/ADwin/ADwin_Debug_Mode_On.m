...
%
%  Notes:
%    We recommend to not use this function in your application software.
%    Instead, run the tool <C:\ADwin\Tools\Test\DebugMode.exe> which has the
%    same function.
...
%      any more.
%    Otherwise, you will get a lot of log files which slows down file management
%    under Windows.
%
%  Example:
