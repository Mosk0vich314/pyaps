...
#Define high_G_current FPAR_50
#Define inter_G_current FPAR_51
#Define low_G_current FPAR_52
...
DIM DATA_1[262144] as float      ' calibration table log amplifier 
...
''''''''''''''''''''''''''''''''''
  ...
  totalcurrent1 = totalcurrent1 + DATA_1[bin1]
  avgcounter = avgcounter + 1
              
  ' get average
  IF(avgcounter = N_avg) THEN
    current_av = totalcurrent1 / N_avg
    avgcounter = 0
    totalcurrent1 = 0
