...
%% Settings
Settings.save_dir = 'E:\Samples\Mickael\MBCJ_test';
Settings.sample = 'test'; %A2-GatetoGate G0b Test_100MOhm_50ohm_termination
Settings.ADC = {1};
Settings.auto = ''; % FEMTOwait_cycles_breaking2
...
Settings.log_calibration_file = 'Curve_20_10_2025_1.25V.mat';
...
Histo.start_V = 0.0;
Histo.number_traces = 10;
Histo.scanrate = 300000;       % Hz  max 300kHz, set by DAC
Histo.points_av = 300;        % points
Histo.output = 2;               % output for drive voltage
Histo.process = 'MCBJ_histogram_log_HiRes_DAC';
