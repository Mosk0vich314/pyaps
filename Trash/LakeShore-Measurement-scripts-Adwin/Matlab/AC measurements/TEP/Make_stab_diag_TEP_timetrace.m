...
%% Settings
Settings.save_dir = 'E:\Samples\Paal\WSe2_S2\Round4\TEP\GlobalArs\6K';         
Settings.sample = 'S1 global gate - sides gates ground'; %A2-GatetoGate G0b Test_100MOhm_50ohm_termination
Settings.auto = ''; %FEMTO
...
Settings.Heaters = 0.3; % mA
Settings.Temperatures = 6; %[105:-15:105];
...
Lockin.dev1.frequency = 40;
Lockin.dev1.harmonic = [1 2 4 6];           %
Lockin.dev1.demod_oscillator = 1;           %
Lockin.dev1.timeconstant = 0.05;           % seconds
...
Lockin.dev2.frequency = 60;           % Hz
Lockin.dev2.harmonic = 1;           %
Lockin.dev2.amplitude_Vbias = 5;           % amplitude bias oscillation for conductance measurement mV
Lockin.dev2.ramp_rate = 1;           % mV / s
Lockin.dev2.V_per_V = 0.01;
Lockin.dev2.model = 'ZI_MFLI';
Lockin.dev2.input_diff = 'A';
Lockin.dev2.input_range = 1;
Lockin.dev2.Vgain = 1;
...
%Timetrace.actual_runtime = Get_integer_multiple_periods(Lockin.dev1.frequency, Lockin.dev2.frequency);
...
Timetrace.runtime = Timetrace.actual_runtime  + 100; % add time to account for potential losses of connection
