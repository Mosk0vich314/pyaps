...
EVENT:
  ...
  SELECTCASE PAR_30 'measurement: 0 = ramp voltage
      ...
      SELECTCASE waitflag '0=wait, 1=measure
        ...
        CASE 1
          ...
          IF(avgcounter = PAR_15) THEN
            ...
            IF(DATA_2[PAR_31] <= FPAR_30) THEN  PAR_30 = 2 
            PAR_31 = PAR_31 + 1
    ...
    CASE 2 'record during breaking 2
      ...
      SELECTCASE waitflag '0=wait, 1=measure
        ...
        CASE 1
          ...
          IF(avgcounter = PAR_15) THEN
            ...
            IF(DATA_2[PAR_31] <= FPAR_31) THEN PAR_30 = 3 
            PAR_31 = PAR_31 + 1
    ...
    CASE 3 'record during post breaking
      ...
      'piezocounter = piezocounter + 1
      'IF(piezocounter = PAR_24) THEN   
      '  inc(PAR_1)
      '  IF (PAR_1 > 65535) THEN 'check if outside piezo range
      '    PAR_59 = 3
      '    PAR_1 = 65535
      '  ENDIF
      '  DAC(PAR_78,PAR_1)
      ...
      PAR_37 = postbreakingcounter
      
      IF(postbreakingcounter = PAR_36) THEN   
        PAR_30 = 4
        waitflag = 0
        totalcurrent1 = 0
        totalcurrent2 = 0
    ...
    CASE 4 'record during making
      ...
      SELECTCASE waitflag '0=wait, 1=measure
        ...
        CASE 1
          ...
          IF(avgcounter = PAR_15) THEN
            ...
            IF(DATA_7[PAR_32] >= FPAR_32) THEN PAR_30 = 5
            PAR_32 = PAR_32 + 1
      ...
      'piezocounter = piezocounter + 1
      'IF(piezocounter = PAR_25) THEN   
      '  dec(PAR_1)
      '  IF (PAR_1 < 32768) THEN 'check if outside piezo range
      '    PAR_59 = 4
      '    PAR_1 = 32768
      '  ENDIF
      '  DAC(PAR_78,PAR_1)
