function [Timetrace, Lockin1] = Realtime_timetrace_frequency_dependance_conductance(Settings, Timetrace, Lockin1, Lockin2, figure_name)
%% initialize figure
...
if isempty(fig)
    ...
    set(gca,'xlim',[Lockin2.frequencies(1) Lockin2.frequencies(end)])
    set(gca, 'XScale', 'log')
    set(gca, 'YScale', 'log')
    xlabel('Conductance frequency (Hz)')
    ylabel('DC current (A)')
    ...
    xlabel('Conductance frequency (Hz)')
    ylabel('X_{\omega} - Conductance (S)')
    set(gca,'xlim',[1 length(Lockin2.frequencies)])
    set(gca,'xlim',[Lockin2.frequencies(1) Lockin2.frequencies(end)])
    set(gca, 'XScale', 'log')
    set(gca, 'YScale', 'log')
end
...
figure(fig);
subplot(2, 3, 1);hold on
plot(Lockin2.frequencies(Timetrace.index), abs(Lockin1.voltage(Timetrace.index,1)), '.','markersize',24,'color',[0, 0.4470, 0.7410])

subplot(2, 3, 2);hold on
plot(Lockin2.frequencies(Timetrace.index), sqrt(Lockin1.voltage(Timetrace.index,3).^2 + Lockin1.voltage(Timetrace.index,4).^2), '.','markersize',24,'color',[0, 0.4470, 0.7410])

subplot(2, 3, 3);hold on
plot(Lockin2.frequencies(Timetrace.index), abs(Lockin1.voltage(Timetrace.index,3)) , '.','markersize',24,'color',[0, 0.4470, 0.7410])

subplot(2, 3, 4);hold on
plot(Lockin2.frequencies(Timetrace.index), abs(Lockin1.voltage(Timetrace.index,4)), '.','markersize',24,'color',[0, 0.4470, 0.7410])

subplot(2, 3, 5);hold on
plot(Lockin2.frequencies(Timetrace.index), abs(Lockin1.voltage(Timetrace.index,5)), '.','markersize',24,'color',[0, 0.4470, 0.7410])

subplot(2, 3, 6);hold on
plot(Lockin2.frequencies(Timetrace.index), abs(Lockin1.voltage(Timetrace.index,6)), '.','markersize',24,'color',[0, 0.4470, 0.7410])