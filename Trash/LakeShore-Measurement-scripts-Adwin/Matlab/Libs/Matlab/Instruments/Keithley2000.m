classdef Keithley2000 < handle
    ...
    methods
        ...
        function Keithley = Keithley2000(address)
            ...
            % get PLC
            string = sprintf(':%s:NPLC?', Keithley.mode);
